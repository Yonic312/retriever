...
function del(){
	location.href="${path}/memberController?sw=D&mid=${li.get("mid")}"
}
</script>
...
<section>
	...
	<tr> 
		  <td colspan=4 align="center" >
	       <input  type=submit class=button value="저장하기" /> &emsp; <input  type="button" Onclick = del() class=button value="삭제하기" /> &emsp;
	      </td>
	</tr>
